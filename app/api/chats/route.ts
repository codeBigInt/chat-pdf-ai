...
export async function POST(request: Request) {
    try {
        ...
        const stream = streamText({
            ...
            - Ensure the response reflects the document's specific context.
